...
Hivemind started as a fork of [claude-squad](https://github.com/smtg-ai/claude-squad) by smtg-ai and has since been significantly rewritten and extended into an independent project.
